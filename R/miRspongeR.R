...
## Internal functions (compute_null_model, compute_p_values, determine_cutoffs_for_null_model_partitionin, 
## isplitDT2, dtcomb, sponge_compute_p_values, sponge_build_null_model) of SPONGE method are from
## the website: https://github.com/biomedbigdata/SPONGE/. Copyright Licensed under
## The GNU General Public License (GPL), Version 3.0 (the 'License'); you may not use this file except in
## compliance with the License. You may obtain a copy of the License at
...
# Merging data tables efficiently
dtcomb <- function(...) {
  rbindlist(list(...))
}
