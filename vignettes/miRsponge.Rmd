...
In miRsponge package, we implement miRHomology method based on the 
...
The pc function consider expression data based on miRHomology method. 
...
In miRsponge package, we implement sppc method based on sensitivity 
...
In miRsponge package, the hermes method predicts competing endogenous RNAs 
...
In miRsponge package, the ppc method is a variant of the hermes method. 
...
In miRsponge package, we implement the muTaME method based on the logarithm 
...
In miRsponge package, we implement the cernia method based on the 
